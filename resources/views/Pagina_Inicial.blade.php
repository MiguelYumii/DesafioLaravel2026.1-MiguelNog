...
<body class="bg-[#1a1a1a] min-h-screen w-full font-sans text-white  m-0 p-0 block" >
    ...
    <section class="mb-8 w-full">
            ...
            <div class="flex items-center gap-1 mb-1">
                ...
                <h1 class="text-sm font-bold">Mais Comprados</h2>
            </div>
    ...
    <!--------------------------->
        ...
        <h2 class="text-lg font-bold mb-4">Mais Vendidos de cada Categoria</h2>

        <main class="bg-[#e5e5e5] w-full rounded-2xl overflow-hidden pb-8 text-black shadow-lg">
