<!DOCTYPE html>
<html lang="pt-br" class="bg-[#1a1a1a] overflow-x-hidden"> 
...
<body class="bg-[#010D23] min-h-screen w-full font-sans text-white m-0 p-0 block overflow-x-hidden" >
        ...
        <!-- ===== BARRA DE BUSCA COM FILTRO ===== -->    
            ...
            @if(request('termo') || request('product_category'))
                    ...
                    <h2 class="text-xl md:text-2xl font-bold ml-4 md:ml-10 mt-8 mb-4 text-white">
                        Resultados para: <span class="text-blue-500">"{{ request('termo') ?: request('product_category') }}"</span>
                    </h2>
                    
                    <main class="bg-white mx-4 md:mx-10 rounded-2xl p-4 md:p-8 text-black shadow-lg mb-8"> 
            ...
            <!-- ========== CASO NÃO TENHA ========= -->
                            ...
                            <div class="flex flex-col justify-center items-center col-span-full text-center text-gray-500 py-10 font-bold text-lg md:text-xl">
                                Nenhum produto encontrado com esse termo ou filtro. 
                                <img src="/assets/Logos/GordoTriste.jpeg" alt="Gordo Triste" class="mt-4 h-[100px] md:h-[150px]">
                            </div>
                            @endforelse
                        </div>

                        <div class="mt-8 flex justify-center w-full overflow-x-auto">
        ...
        <section class="mb-8 w-full mt-4">
            <div class="flex items-center gap-1 mb-1">
                <h1 class="text-lg md:text-[20px] font-bold mt-7 ml-4 md:ml-10">⭐Destaque</h1>
            </div>

            <div class="bg-[#d4d4d4] p-2 md:p-6 mx-4 md:mx-10 rounded-xl">
                <div id="product-carousel" class="relative w-full" data-carousel="slide">
                    <div class="relative h-[850px] sm:h-[600px] lg:h-80 overflow-hidden rounded-lg">
    ...
    <!-- =====  DESTAQUE DE CADA CATEGORIA ===== --> 
        ...
        <h2 class="text-xl md:text-2xl font-bold ml-4 md:ml-10">Destaque de cada Categoria</h2>
        <main class="bg-[#e5e5e5] mx-4 md:mx-10 rounded-2xl overflow-hidden pb-8 text-black shadow-lg">            


    <!-- =========== COMPUTADORES ============ -->            
       
        <div class="w-full">
                <h3 class="font-bold text-sm md:text-base px-6 pt-4 pb-2">Computadores</h3>
                <div class="bg-[#d4d4d4] p-2 md:p-6 mx-2 md:mx-6 rounded-xl relative">
                    <div id="carousel-computadores" class="relative w-full" data-carousel="slide">
                        ...
                        <button type="button" class="absolute top-0 start-0 z-30 flex items-center justify-center h-full px-1 md:px-4 group focus:outline-none" data-carousel-prev>
                            <span class="inline-flex items-center justify-center w-8 h-8 md:w-10 md:h-10 rounded-full bg-white/50 group-hover:bg-white/80 transition-all shadow">
                                <svg class="w-3 h-3 md:w-4 md:h-4 text-gray-800" fill="none" viewBox="0 0 6 10"><path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 1 1 5l4 4"/></svg>
                            </span>
                        </button>
                        <button type="button" class="absolute top-0 end-0 z-30 flex items-center justify-center h-full px-1 md:px-4 group focus:outline-none" data-carousel-next>
                            <span class="inline-flex items-center justify-center w-8 h-8 md:w-10 md:h-10 rounded-full bg-white/50 group-hover:bg-white/80 transition-all shadow">
                                <svg class="w-3 h-3 md:w-4 md:h-4 text-gray-800" fill="none" viewBox="0 0 6 10"><path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="m1 9 4-4-4-4"/></svg>
                            </span>
                        </button>
                    </div>
                </div>
    ...
    <!-- ===========  PERIFÉRICOS  =========== --> 
        <div class="w-full">
                <h3 class="font-bold text-sm md:text-base px-6 pt-4 pb-2">Periféricos</h3>
                <div class="bg-[#d4d4d4] p-2 md:p-6 mx-2 md:mx-6 rounded-xl relative">
    ...
    <!-- ============  DOMÉSTICOS  ============= --> 
    <div class="w-full">
                <h3 class="font-bold text-sm md:text-base px-6 pt-4 pb-2">Domésticos</h3>
                <div class="bg-[#d4d4d4] p-2 md:p-6 mx-2 md:mx-6 rounded-xl relative">
